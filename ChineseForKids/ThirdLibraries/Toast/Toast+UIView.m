...
- (CGPoint)getPositionFor:(id)point toast:(UIView *)toast {
    ...
    if([point isKindOfClass:[NSString class]]) {
        ...
        if( [point caseInsensitiveCompare:@"top"] == NSOrderedSame ) {
            ...
            {
                return CGPointMake(self.bounds.size.width/2, (self.bounds.size.height - (toast.frame.size.height / 2)) - kVerticalPadding - 60);
            }
            else
            {
                return CGPointMake(self.bounds.size.width/2, (self.bounds.size.height - (toast.frame.size.height / 2)) - kVerticalPadding - 35);
            }
...
- (UIView *)makeViewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        [titleLabel setFont:[UIFont fontWithName:@"迷你简少儿" size:kFontSize]];
    ...
    if (message != nil) {
        ...
        [messageLabel setFont:[UIFont fontWithName:@"迷你简少儿" size:kFontSize]];
