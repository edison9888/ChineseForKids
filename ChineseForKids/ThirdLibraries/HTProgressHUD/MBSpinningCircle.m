...
-(CGGradientRef)gradient
{
    ...
    CGGradientRef gradientRef = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)gradientColors, gradientLocations);
...
-(void)drawAnnular
{
    ...
    */
    ...
    CGFloat radius = (self.bounds.size.width - 4 - lineWidth)/2;
    CGFloat startAngle = - ((float)M_PI_2 - progress*2);
    ...
    CGFloat endAngle = ((float)M_PI_2 + startAngle);
