...
// Make changes to TranslationModel.h instead.

#import <CoreData/CoreData.h>


extern const struct TranslationModelAttributes {
...
} TranslationModelAttributes;

extern const struct TranslationModelRelationships {
} TranslationModelRelationships;

extern const struct TranslationModelFetchedProperties {
} TranslationModelFetchedProperties;
...
@interface TranslationModelID : NSManagedObjectID {}
@end

@interface _TranslationModel : NSManagedObject {}
...
@interface _TranslationModel (CoreDataGeneratedAccessors)

@end

@interface _TranslationModel (CoreDataGeneratedPrimitiveAccessors)
