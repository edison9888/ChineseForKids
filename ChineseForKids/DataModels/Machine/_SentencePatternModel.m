...
// Make changes to SentencePatternModel.m instead.

#import "_SentencePatternModel.h"

const struct SentencePatternModelAttributes SentencePatternModelAttributes = {
	.english = @"english",
...
const struct SentencePatternModelRelationships SentencePatternModelRelationships = {
};

const struct SentencePatternModelFetchedProperties SentencePatternModelFetchedProperties = {
};

@implementation SentencePatternModelID
@end

@implementation _SentencePatternModel

+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription insertNewObjectForEntityForName:@"SentencePatternModel" inManagedObjectContext:moc_];
}

+ (NSString*)entityName {
	return @"SentencePatternModel";
}

+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription entityForName:@"SentencePatternModel" inManagedObjectContext:moc_];
}

- (SentencePatternModelID*)objectID {
	return (SentencePatternModelID*)[super objectID];
}
